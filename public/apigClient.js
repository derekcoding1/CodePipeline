...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://hc2lboo5da.execute-api.us-east-1.amazonaws.com/v1/';
    ...
    apigClient.folderPut = function (params, body, additionalParams) {
        ...
        var uploadBucketKeyPutRequest = {
			...
			//path: pathComponent + uritemplate('/{bucket}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', ])),
